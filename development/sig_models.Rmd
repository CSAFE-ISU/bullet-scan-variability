...
grid_test$data <- orange_grid



subset_by_100 <- seq(1, max(orange_grid$x_aligned), by = 100)
...
orange_l1_model_sub <- lmer(sig2 ~ fixed_BLm + (1|bullet) + (1|operator), data = orange_subset_l1)
orange_l2_model_sub <- lmer(sig2 ~ fixed_BLm + (1|bullet) + (1|operator), data = orange_subset_l2)
orange_l3_model_sub <- lmer(sig2 ~ fixed_BLm + (1|bullet) + (1|operator), data = orange_subset_l3)
