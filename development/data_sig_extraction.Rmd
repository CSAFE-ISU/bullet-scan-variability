...
```{r}
orange_crosscuts <- readRDS("../data/variability_scans/orange_123_cc.rda")
...
shinyApp(
  ...
  server = function(input, output, session) {
    ...
    observeEvent(input$save,{
      saveRDS(grooves, file="../data/variability_scans/orange_123_grooves.rda")
...
```{r}
grooves <- readRDS("../data/variability_scans/orange_123_grooves.rda")
...
saveRDS(orange_sigs, "../data/variability_scans/orange_123_sigs.rda")
```
...
```{r}
green_crosscuts <- readRDS("../data/variability_scans/green_123_cc_full.rda")
...
shinyApp(
  ...
  server = function(input, output, session) {
    ...
    observeEvent(input$save,{
      saveRDS(grooves, file="../data/variability_scans/green_123_grooves.rda")
      cat("groove data saved\n")
    })
...
```{r}
green_grooves <- readRDS("../data/variability_scans/green_123_grooves.rda")
...
saveRDS(green_sigs, "../data/variability_scans/green_123_sigs.rda")
```
...
```{r}
pink_crosscuts <- readRDS("../data/variability_scans/pink_123_cc.rda")
...
shinyApp(
  ...
  server = function(input, output, session) {
    ...
    observeEvent(input$save,{
      saveRDS(grooves, file="../data/variability_scans/pink_123_grooves.rda")
      cat("groove data saved\n")
    })
...
```{r}
pink_grooves <- readRDS("../data/variability_scans/pink_123_grooves.rda")
...
saveRDS(pink_sigs, "../data/variability_scans/pink_123_sigs.rda")
```
