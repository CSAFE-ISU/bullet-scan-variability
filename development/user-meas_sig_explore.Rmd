...
b6l1_long %>% ggplot() + 
  geom_line(aes(x = x_aligned, y = sig2, group = scan_id, color = factor(Operator))) + 
...
error_plot_65 <- sig_errors %>%
  filter( unique_id == "BL 6-5") %>% 
  ggplot() + 
  geom_line(aes(x = x_aligned, y = sig_error, group = scan_id, color = factor(Operator)), alpha = 0.7) +
