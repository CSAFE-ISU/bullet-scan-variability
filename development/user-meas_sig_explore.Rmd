...
mean_plot_65 <- sig_errors %>% 
  ...
  ggplot() + 
  geom_line(aes(x = x, y = sig2, group = scan_id, color = factor(Operator)), alpha = 0.7) + 
  geom_line(aes(x = x, y = mean_sig), color = "black") + 
  theme_bw() + 
  #facet_wrap(Bullet~unique_id, nrow = 2) + 
...
error_plot_65 <- sig_errors %>%
  filter( unique_id == "BL 6-5") %>% 
  ggplot() + 
  geom_line(aes(x = x, y = sig_error, group = scan_id, color = factor(Operator)), alpha = 0.7) +
...
sig_errors %>% 
  ...
  ggplot() + 
  geom_line(aes(x = x, y = sig2, group = scan_id, color = factor(Bullet)), alpha = 0.7) + 
  geom_line(aes(x = x, y = mean_sig), color = "black") + 
  theme_bw() + 
